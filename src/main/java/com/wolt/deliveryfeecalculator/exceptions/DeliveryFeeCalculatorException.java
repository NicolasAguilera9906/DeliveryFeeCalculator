...
public class DeliveryFeeCalculatorException extends Exception {
     ...
     */
    public DeliveryFeeCalculatorException(String message, Throwable cause, HttpStatus status) {
        super(message, cause);
        this.status = status;
    }
     ...
     * @param status  The HTTP Status Code Of The Error.
     */
    public DeliveryFeeCalculatorException(String message, HttpStatus status) {
        super(message);
        this.status = status;
    }
